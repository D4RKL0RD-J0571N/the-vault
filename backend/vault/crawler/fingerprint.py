...
class ProjectFingerprinter:
    ...
    def get_primary_language(self, directory: Path, project_type: ProjectType) -> Optional[str]:
    ...
    def _get_directory_timestamps(self, directory: Path) -> Dict[str, Optional[datetime]]:
