...
class ProjectBase(BaseSchema):
    ...
    language_primary: Optional[str] = Field(
...
class ProjectUpdate(BaseSchema):
    ...
    health_score: Optional[float] = Field(
        None, description="Project health score (0-1)"
    )
...
class ScanRequest(BaseSchema):
    ...
    root_directories: Optional[List[str]] = Field(
        None, description="Root directories to scan"
    )
...
class ParseRequest(BaseSchema):
    ...
    project_ids: Optional[List[UUID]] = Field(
        None, description="Specific project IDs to parse"
    )
...
class ParseResponse(BaseSchema):
    ...
    projects_attempted: Optional[int] = Field(
        None, description="Number of projects attempted"
    )
...
class StatusResponse(BaseSchema):
    ...
    is_parsing: bool = Field(
        ..., description="Whether project is currently being parsed"
    )
